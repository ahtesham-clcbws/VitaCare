...
const ArticleCard = ({ img, title, date, description, layout, hidden }: any) => (
  <a href="#" 
  className={`${hidden ? "hidden sm:block" : ""} ${layout} max-w-sm mx-auto group bg-gray-900 hover:no-underline focus:no-underline`}>
    <img
      src={img}
      alt=""
      className="object-cover w-full h-44 rounded bg-gray-500"
    />
